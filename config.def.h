...
static char *font2[] = {
  ...
  "WenQuanYi Micro Hei:pixelsize=20:antialias=true:autohint=true",
...
static const char *colorname[] = {
	...
	"#5588FF",
	"#555555",
	"#fffbf6", /* default foreground colour */
 ...
 */
// NOTE: the scrathpad settings is located in the dwm config.def.h
